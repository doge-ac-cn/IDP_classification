...
def main():
    ...
    for patient_name_train_index, patient_name_test_index in kfold.split(patients_names):
        ...
        train_transforms = Compose([
            ...
            # SpatialPadd(keys=["img"], spatial_size=(96, 96)),
        ...
        train_loader = DataLoader(train_ds, batch_size=64, shuffle=True, num_workers=20, pin_memory=torch.cuda.is_available())
        
        val_ds = monai.data.Dataset(data=val_files, transform=val_transforms)
        val_loader = DataLoader(val_ds, batch_size=64, num_workers=20, pin_memory=torch.cuda.is_available())
