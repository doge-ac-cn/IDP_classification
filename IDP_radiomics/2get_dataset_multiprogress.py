    ...
    for class_dir in os.listdir(data_dir):
        ...
        for patient_dir in  tqdm.tqdm(os.listdir(class_path)):
            ...
            for mask in masks:
                ...
                tasks.append(process_pool.submit(extract_features_from_roi, images[0], mask,save_npy_name))
    ...
    for class_dir in os.listdir(save_dir):
        ...
        for patient_dir in  tqdm.tqdm(os.listdir(save_class_path)):
            ...
            for feature_filename in feature_npy:
                features.append( copy.deepcopy(np.load(feature_filename) ))
                labels.append(int(os.path.basename(feature_filename)[0]))
...
def main():
    ...
    # Load data
    # load_data(data_dir,save_dir)
    X, y , patients_array = gen_npy(save_dir)
